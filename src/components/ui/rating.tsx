  ...
  return (
    <div className="flex items-center gap-0.5">
      {[...Array(fullBubbles)].map((_, i) => (
        <svg key={`full-${i}`} width={size} height={size} viewBox="0 0 24 24" fill="#053a1a" xmlns="http://www.w3.org/2000/svg">
          <circle cx="12" cy="12" r="10" />
        </svg>
      ))}
      {hasHalf && (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="12" cy="12" r="10" stroke="#053a1a" strokeWidth="2" />
          <path d="M12 2A10 10 0 0 0 12 22V2Z" fill="#053a1a" />
        </svg>
      )}
